...
function updateDayChart() {
  const dataSolarDay1 = chartDaySolar1.value?.map((solar) =>
    Number(solar.value.toFixed(2))
  );
    ...
    <div class="container">
      ...
      >
        <div class="flex flex-col">
          ...
          <!--         hamma yillik jami quvvat -->
          <div class="flex items-center gap-2 px-4 justify-between">
            <p class="text-lg flex items-center gap-4">
              Общая годовая мощность
            </p>
            <div>
              <span class="text-4xl font-semibold mr-1">{{
        ...
        >
          <div class="flex gap-3">
            ...
            <div class="basis-[50%] md:basis-[38%] flex flex-col gap-[1px]">
              ...
              <InfoText
                title="f"
                :rate="infoStore.info?.data?.solar_1?.f"
                unity="Hz"
              />
            </div>
          </div>
        ...
        >
          <div class="flex gap-3">
            ...
            <div class="basis-[50%] md:basis-[38%] flex flex-col gap-[1px]">
              ...
              <InfoText
                title="f"
                :rate="infoStore.info?.data?.solar_2?.f"
                unity="Hz"
              />
            </div>
          </div>
            ...
            <div class="flex items-center gap-2 ml-2">
              ...
              <div>
                ...
                <p>
                  Time :
                  {{
                    formatDate(infoStore.info?.max?.solar_2?.created_at).hours
                  }}
                </p>
              </div>
            </div>
